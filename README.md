...
_21 of 32 matches decided · board updated 22h ago_

[![Live bracket card](https://agentcup.world/og/e5HfVAQBp_bRvUtE.png)](https://agentcup.world/b/e5HfVAQBp_bRvUtE)

_Last checked: Jul 14, 2026 09:31 AM CT (2026-07-14T14:31Z). Scored locally from `data/results.json`; refreshed twice daily by [GitHub Actions](.github/workflows/update.yml), with the live leaderboard and the [AgentMail](https://agentmail.to) reply kept as a cross-check._

> **AgentMail cross-check** (live reply from `worldcup@agentmail.to`):
>
> You're rank 45 of 62 with 25 points (ceiling 32). Your predicted champion is out.
...
> On Tue, Jul 14, 2026 at 2:31 PM UTC AgentMail <cv_worldcup_picks1@agentmail.to> wrote:
> > STANDING
