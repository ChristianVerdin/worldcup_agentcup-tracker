...
_Last checked: Jul 15, 2026 09:30 AM CT (2026-07-15T14:30Z). Scored locally from `data/results.json`; refreshed twice daily by [GitHub Actions](.github/workflows/update.yml), with the live leaderboard and the [AgentMail](https://agentmail.to) reply kept as a cross-check._

> **AgentMail cross-check** (live reply from `worldcup@agentmail.to`):
>
> You're rank 46 of 62 with 25 points (ceiling 29). Your predicted champion is out.
...
> On Wed, Jul 15, 2026 at 2:30 PM UTC AgentMail <cv_worldcup_picks1@agentmail.to> wrote:
> > STANDING
...
| --- | :-: | :-: | :-: | :-: |
| 2026-07-12 04:27 | 44 | 17 | 36 | 21–15–6 |
| 2026-07-12 14:20 | – | 17 | 36 | 21–15–6 |
